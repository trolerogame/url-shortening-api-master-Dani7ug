...
`;var $="/url-shortening-api-master-Dani7ug/assets/illustration-working.fae884c2.svg",A=[{id:1,img:"./icon-brand-recognition.svg",title:"Brand Recognition",text:"Boost your brand recognition with each click. Generic links don\u2019t mean a thing. Branded links help instil confidence in your content."},{id:2,img:"./icon-detailed-records.svg",title:"Detailed Records",text:"Gain insights into who is clicking your links. Knowing when and where people engage with your content helps inform better decisions."},{id:3,img:"./icon-fully-customizable.svg",title:"Fully Customizable",text:"  Improve brand awareness and content discoverability through customizablelinks, supercharging audience engagement."}],P="/url-shortening-api-master-Dani7ug/assets/bg-shorten-mobile.53ca2a05.svg",R="/url-shortening-api-master-Dani7ug/assets/bg-shorten-desktop.d119628f.svg";const U=r.form`
    width: calc(100% - 100px);
    padding:30px;
    background: hsl(257, 27%, 26%) url(${P}) no-repeat;
    border-radius:10px;
...
`,T=({shortsUrls:t,setShortsUrls:a})=>{const o=p.exports.useRef(null),[s,n]=p.exports.useState(!1),i=async l=>{l.preventDefault();const c=o.current.value;if(!c)return n(!0);try{const x=(await(await fetch(`https://api.shrtco.de/v2/shorten?url=${c}`)).json()).result.full_short_link;a([...t,{url:c,shortUrl:x}]),n(!1)}catch{n(!0)}o.current.value=""};return e.createElement(U,{empty:s,onSubmit:i},e.createElement("div",null,e.createElement("input",{ref:o,type:"text",placeholder:"Shorten a link here..."}),s&&e.createElement("p",null,"Please add a link")),e.createElement(d,null,"Shorten It!"))},G=({shortsUrls:t,setShortsUrls:a})=>{const[o,s]=p.exports.useState(null),n=(i,l)=>{navigator.clipboard.writeText(l),s(i)};return e.createElement("main",null,e.createElement(D,null,e.createElement("img",{src:$,alt:""}),e.createElement(j,null,e.createElement("h1",null,"More Than just shorter links"),e.createElement("p",null,"Build your brand\u2019s recognition and get detailed insights on how your links are performing."),e.createElement(d,null,"Get Started"))),e.createElement(L,null,e.createElement(T,{shortsUrls:t,setShortsUrls:a}),e.createElement(F,null,t.map((i,l)=>e.createElement(V,{key:l,copied:o==l&&o!==null?"true":"false"},e.createElement("div",null,e.createElement("p",null,i.url)),e.createElement("div",null,e.createElement("b",null,i.shortUrl),e.createElement(d,{onClick:()=>n(l,i.shortUrl)},o==l&&o!==null?"Copied!":"Copy"))))),e.createElement(M,null,e.createElement("h3",null,"Advanced Statistics"),e.createElement("p",null,"Track how your links are performing across the web with our advanced statistics dashboard.")),e.createElement(B,null,A.map(({id:i,img:l,title:c,text:g})=>e.createElement(I,{key:i},e.createElement("img",{src:l,alt:""}),e.createElement("b",null,c),e.createElement("p",null,g))))))};var O="/url-shortening-api-master-Dani7ug/assets/bg-boost-mobile.683c4474.svg",H="/url-shortening-api-master-Dani7ug/assets/bg-boost-desktop.05593952.svg";const N=r.footer`
    display:flex;
    flex-direction:column;
    align-items:center;
    background:#111;
